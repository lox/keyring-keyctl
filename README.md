keyring-keyctl
==============
[![CI](https://github.com/lox/keyring-keyctl/actions/workflows/test.yml/badge.svg?branch=main)](https://github.com/lox/keyring-keyctl/actions/workflows/test.yml)
